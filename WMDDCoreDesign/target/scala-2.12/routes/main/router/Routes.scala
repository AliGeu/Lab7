...
class Routes(
  ...
  // @LINE:10
  private[this] lazy val controllers_HomeController_clients4_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("clients")))
  )
  private[this] lazy val controllers_HomeController_clients4_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:10
    case controllers_HomeController_clients4_route(params@_) =>
      call { 
        controllers_HomeController_clients4_invoker.call(HomeController_0.clients)
      }
